		...
		return (
			<section className={"wh-record " + (this.props.embedded ? "embedded" : "container") + (hasSteps ? " has-steps" : " no-steps")}>
				...
				<Form>
					...
					<Button grid={!this.props.embedded} onClick={this.props.onRecordClick} containerClassName="record" className={recordButtonClass}><strong>{t("Record")}</strong> <object type="image/svg+xml" data={recordIcon}></object></Button>
